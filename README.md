...
<html>
  <head>
    ...
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.15.3/css/all.min.css" intefrity="sha512-iBBXm8fW90+nuLcSklbmPcLa0OT92xO1BIsZCvqsWgccV3gFoRBv0z+8dLJgyAHIhR35VZc2oM/gI1w==" crossorigin="anonymous" referrerpolicy="no-reffer">
    </head>
    <body>  
...
<!-- navbar -->
  ...
  <div class="container-fluid">
    <a class="navbar-brand" href="#">KALLEPALLI PRANEETHA</a>
...
<main class="container mt-3">
  <section id="hero" class="d-flex justify-content-sm-center justify-content-md-evenly align-items-center  mx auto flex-column-reverse gap-3 flex-md-row">
    ...
    <div class="d-flex justify-content-sm-center align-items-center flex-column justify-content-md start align-items-md-start">
      <h5>Hi 👋🏼</h5>
      <h1> I'm KALLEPALLI PRANEETHA</h1>
      <p>A fullstack web developer!</p>
      <button class="btn btn-success btn-sm">My cool resume👨🏼‍🎓</button>
</div>

<div class=" d-md-none w-50 w-50">
<img src="https://tse1.mm.bing.net/th?id=OIP.hSVEOhcfJl25sN5XHBcu4AHaHa&pid=Api&P=0&w=300&"alt="praneetha" class="w-100 h-100 rounded-circle shodow">
</div>
...
<div class= "mt-4 d-md-none d-flex justify-content-evenly">
  ...
  <div class="card-body">
    ...
    <a href="#" class="btn btn-dark">View source <i class="fab fa-github"></i></a>
     ...
     <section id="contact" class="mt4 py-4">
      <!-- Contact me -->
...
<div class="mb-3">
  ...
  <input type="email" requied class="form-control" id="exampleFormControlInput1" placeholder="name@example.com">
</div>
<div class="mb-3">
  <label for="exampleFormControlTextarea1" class="form-label">Your Message</label>
  <textarea class="form-control" id="exampleFormControlTextarea1" requied placeholder="enter your amazing message!"rows="3"></textarea>
</div>
...
<div class="col-sm col-md-4">
    <div class="mt-3">
      <h4><i class="fas fa-at text-primary"></i>praneetha@gmail.com</h4>
